...
//Code here
favoriteThings.car = 'Honda Civic 2017 type R'
...
let {car, fat, protein} = ingredients
...
let cat1 = new Cat('sheila', 7, 'black')
...
let wizard1 = new Wizard('Voldemort', 51, 'fireball')
...
//Code Here
let phone1 = new Phone('google', 'pixel 3', 256, 'black', 600)
let phone2 = new Phone('samsung', 'galaxy S21', 512, 'midnight', 800)
let phone3 = new Phone('apple', 'iPhone', 512, 'silver', 1050)
...
//Code Here
myFirstVehicle = new Vehicles(5, 'pearl white', 95000)
...
//Code Here 
let myFirstMotorcycle = new Motorcycle(2, 'black', 26500, 'Suzuki', true)
...
//Code Here
let myFirstBoat = new Boat(9, 'white', 78, 'Bessie', 'boat', false)
